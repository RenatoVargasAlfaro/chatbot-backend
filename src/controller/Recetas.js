...
module.exports = {
    getRecipe: async (req, res) => {
        ...
        //res.json(docs);
        await db.collection('Receta').find().toArray(function(err, result) {
            if (err) throw err;
    ...
    addRecipe: async (req, res) => {
        ...
        await db.collection('Receta').insertOne(cultura, function(err, res) {
            if (err) throw err;
            console.log("dato agregado");
        });
    },
    ...
    getRecipebyId: async (req, res) => {
        ...
        await db.collection('Receta').find({_id: ObjectID(dato)}).toArray(function(err, result) {
            if (err) throw err;
            console.log("Dato por id obtenido");
            res.json(result);
        });
